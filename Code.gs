 ...
 * 4. Copy the /exec URL and put it in script.js as ENDPOINT.
 *
...
// Optional for a standalone script: copy the ID between /d/ and /edit in the Sheet URL.
var SPREADSHEET_ID = "";
...
function getSheet() {
  ...
  if (!ss) throw new Error("Set SPREADSHEET_ID or create this script from the destination Google Sheet.");
